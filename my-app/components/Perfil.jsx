  ...
  useEffect(() => {
    async function buscarDadosUsuario() {
      try {
        ...
        // Em um app real, você decodificaria o token para obter o email do usuário
        // Por agora, vamos simular buscando pelo primeiro usuário do tipo correspondente
        const usuario = data.find(pessoa => pessoa.tipo === tipoUsuario);
